<template>
  <div class="container">
<!-- 用户登录   -->
    <div style="width: 400px; padding: 30px; background-color: white; border-radius: 5px;  margin-left: 903px;">
      ...
      <el-form :model="form" :rules="rules" ref="formRef">
        ...
        <div style="display: flex; align-items: center">
          <div style="flex: 1">
            <span><a href="http://localhost:8080/login">用户登录</a></span>
          </div>
...
.container {
  height: 100vh;
  overflow: hidden;
  background-image: url("@/assets/imgs/administrator_login_bg.jpg");
  background-size: 68%;
